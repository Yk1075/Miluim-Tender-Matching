...
def main():
    ...
    # Info section
    st.markdown("""
    <div style="background-color: #d1ecf1; padding: 20px; border-radius: 8px; text-align: center; border: 1px solid #bee5eb;">
        <p>בהמשך להטבות ברכישת קרקע למילואימניקים ונכי צה"ל שפרסמה רשות מקרקעי ישראל, יצרנו עבורכם מערכת ייעודית לחיפוש המכרזים הרלוונטים לפי העדפותיכם. אנו מקווים שתמצאו במערכת כלי שימושי ונשמח ללוות אתכם בתהליך לבניית בית חלומותיכם.</p>
        ...
        <p><strong>אנו מזמינים אתכם להתעמק בפרטי ההטבה <a href="https://www.gov.il/he/pages/pr-miluaim-29042025" target="_blank">באתר של רשות מקרקעי ישראל</a>.</strong></p>
    ...
    st.markdown("""
    <div style="background-color: #fff3cd; padding: 15px; border-radius: 8px; text-align: center; border: 1px solid #ffeaa7; margin-top: 15px;">
        <p><strong>המידע באתר מוצג כפי שהוא (as is) ומבוסס על פרסומי רשות מקרקעי ישראל (רמ"י).</strong> אין לראות במידע זה תחליף לייעוץ משפטי, מקצועי או אחר, והשימוש בו והסתמכות על האמור בו נעשה על אחריות המשתמש בלבד. האתר אינו קשור באופן רשמי לרשות מקרקעי ישראל.</p>
