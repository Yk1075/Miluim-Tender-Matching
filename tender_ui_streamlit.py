    ...
    with results_col:
        if st.session_state.search_performed:
            ...
            if not st.session_state.matches.empty:
                ...
                st.info("""
<span style="font-size:18px; font-weight:bold;">משרד עמית, פולק, מטלון ושות׳ מעריך ומוקיר את מערך משרתי ומשרתות המילואים ומאחלים לשובם של כל חיילי צה"ל בשלום הבייתה יחד עם החטופים והחטופות.</span>
