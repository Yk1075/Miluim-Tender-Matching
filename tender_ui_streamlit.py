    ...
    with search_col:
        with st.container():
            ...
            days_in_6_years = st.number_input(
                ...
                help="יש להזין את מספר ימי המילואים המקסימלי שביצעתם במצטבר (מאז שנת 2000), בפרק זמן של עד 6 שנים קלנדריות רצופות. שימו לב כי במועד הרשמה למכרז יש לצרף אישור אישור על שירות של 80 ימי מילואים בתקופה של עד 6 שנים (דוגמא לאישור הנדרש ניתן למצוא בhttps://www.gov.il/he/pages/pr-miluaim-29042025)",
                key="days_in_6_years"
            )
